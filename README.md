...
WHAT IT DOES:
F.A.R.T. allows you to dynamically reposition Tankers mid-mission using F10 Map Markers, without breaking their tasks. It also draws their current tracks directly onto the F10 map.
...
3. (Optional but recommended) Name the start of its orbit waypoint "TRK1" and the end of its orbit waypoint "TRK2". This saves its "Default" track.
4. Open the Triggers menu. Create a trigger: ONCE -> TIME MORE (5) -> DO SCRIPT FILE (Load this FART.lua file).
